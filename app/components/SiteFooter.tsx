    ...
    <footer className="border-t border-slate-200 bg-white">
      <div className="mx-auto w-full max-w-7xl px-4 py-10">
        <div className="grid gap-8 lg:grid-cols-[1.3fr_1fr_1fr]">
          <div>
            ...
            <p className="mt-2 text-sm leading-relaxed text-slate-600">
              ...
              abierta para que cualquier persona afectada por el terremoto pueda
              pedir y ofrecer ayuda en tiempo real. El proyecto es gratuito, sin
              fines de lucro y de código abierto.
            </p>
            <a
              href={contactMailto()}
              ...
              {[
                ...
                >
                  ...
                  <span className="flex flex-col leading-tight">
                    ...
                    <span className="text-xs text-slate-500">{person.handle}</span>
                  </span>
                </a>
              ))}
            </div>
          ...
          <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
            ...
            <p className="mt-1 text-sm text-slate-700">
              El código es abierto. Reporta bugs, sugiere mejoras o abre un pull
              request: cada aporte ayuda a salvar vidas.
            </p>
            <a
        ...
        <div className="mt-10 border-t border-slate-100 pt-8">
          <h3 className="text-base font-bold text-slate-900">🔗 Sitios aliados</h3>
        ...
        <div className="mt-8 flex flex-col items-center justify-between gap-2 border-t border-slate-100 pt-6 text-center text-xs text-slate-500 sm:flex-row sm:text-left">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 sm:justify-end">
            <Link href="/privacidad" className="hover:text-slate-700 hover:underline">
              Privacidad
            </Link>
